...
export const Skills = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      icon: ShieldCheck,
      skills: SKILLS_BY_CATEGORY.security,
    ...
    <div className="min-h-screen bg-bg-page">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="font-mono text-xs text-accent-500 uppercase tracking-widest mb-3">// skills</div>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-500 text-glow-green mb-4 uppercase tracking-wide">
              Technical Expertise
            </h2>
            <p className="font-mono text-sm text-neutral-400 max-w-2xl mx-auto">
              ...
              return (
                ...
                >
                  ...
                  <div className="terminal-chrome">
                    <span className="ml-1 font-mono text-xs text-neutral-400">ls ~/skills/{category.id}</span>
                  </div>
                  <div className="px-6 pt-5 pb-2">
                    <div className="flex items-center space-x-3">
                      <div className={`p-2 rounded-sm bg-bg-elevated ${category.color}`}>
                        <IconComponent size={22} />
                      </div>
                      <h3 className="font-display text-lg font-semibold text-primary-500 uppercase tracking-wide">
                        {category.title}
                      </h3>
                    </div>
                  </div>
