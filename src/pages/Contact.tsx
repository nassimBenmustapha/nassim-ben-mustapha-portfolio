...
import { Mail, MapPin, Phone, Send, Linkedin, ExternalLink, CheckCircle } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-12 gap-12">
            ...
            >
              <div className="terminal-window">
                <div className="terminal-chrome">
                  <span className="ml-1 font-mono text-xs text-neutral-400">nano message.txt</span>
                </div>
                <div className="p-8">
                <div className="mb-8">
                  <h2 className="font-display text-2xl font-bold text-primary-500 text-glow-green mb-4 uppercase tracking-wide">
                    Send Message
                  </h2>
            ...
            >
              ...
              <div className="terminal-window p-6">
                <h3 className="font-display text-base font-semibold text-primary-500 mb-6 uppercase tracking-wide">
                  Contact Methods
                </h3>
                  ...
                  {contactMethods.map((method) => {
                    ...
                    return (
                      <div key={method.label} className="flex items-center space-x-4">
                        <div className="p-3 bg-bg-elevated rounded-sm text-primary-500 border border-primary-500/20">
                          <IconComponent size={20} />
                        </div>
                        <div>
                          <div className="font-mono text-xs text-neutral-400 uppercase tracking-widest">{method.label}</div>
                          <div className="font-mono text-sm text-neutral-100">{method.value}</div>
                        </div>
                      </div>
                    );
                  })}
              ...
              {/* Availability Status — systemctl style */}
              <div className="terminal-window p-6 font-mono text-sm">
                <div className="text-neutral-400 mb-4">
                  <span className="text-accent-500">$</span> systemctl status availability
                </div>
                <div className="space-y-2 pl-3 border-l-2 border-primary-500/30">
                  <div className="flex items-center gap-3">
                    <span className="w-2.5 h-2.5 rounded-full bg-primary-500 animate-pulse-glow" />
                    <span className="text-primary-500 font-semibold tracking-wider">AVAILABLE FOR HIRE</span>
                  </div>
                  <div className="text-neutral-400">
                    <span className="text-neutral-500">Active:</span> <span className="text-primary-500">active (operational)</span>
                  </div>
                  <div className="text-neutral-400">
                    <span className="text-neutral-500">// RESPONSE TIME</span> — within 24 hours
                  </div>
                  <div className="text-neutral-400">
                    <span className="text-neutral-500">// TIMEZONE</span> — CET (UTC+1)
                  </div>
                </div>
              </div>
                  ...
                  {socialLinks.map((link) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex items-center gap-3 p-4 bg-bg-elevated rounded-sm text-neutral-400 border border-neutral-700 hover:border-primary-500 hover:text-primary-500 transition-all duration-200 hover:shadow-glow-green-sm"
                      >
                        <IconComponent size={20} />
